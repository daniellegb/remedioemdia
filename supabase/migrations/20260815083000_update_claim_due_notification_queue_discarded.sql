-- ============================================================================
-- MIGRATION: Filtro de descarte para claim_due_notification_queue
-- Ignora itens descartados (sem subscription / desabilitados) ou falhos permanentemente
-- ============================================================================
...
BEGIN
  ...
  WITH claimed AS (
    ...
    WHERE sent = false
      ...
      AND (metadata IS NULL OR metadata->>'status' IS NULL OR metadata->>'status' NOT IN ('discarded', 'failed'))
