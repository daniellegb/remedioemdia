-- ============================================================================
-- MIGRATION: Garante RPC claim_due_medication_occurrences e Cron Dispatcher
-- ============================================================================
...
-- Identifica lembretes devidos (next_occurrence_at <= NOW()), gera itens na notification_queue e atualiza o próximo horário
