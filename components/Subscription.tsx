  ...
  return (
    ...
    >
      ...
      {!IS_SUBSCRIPTION_ENABLED ? (
        /* Aviso temporário enquanto as assinaturas estiverem desabilitadas */
        <div id="subscription-notice-card" className="bg-white rounded-3xl border border-slate-100 shadow-sm p-6 md:p-8 space-y-4">
          <div className="w-12 h-12 bg-blue-50 text-blue-600 rounded-2xl flex items-center justify-center">
            <Sparkles size={24} className="text-blue-600" />
          </div>
          <div className="space-y-2">
            <h3 className="text-lg font-bold text-slate-900 leading-snug">
              O Remédio em Dia está em evolução constante.
            </h3>
            <p className="text-sm text-slate-600 leading-relaxed font-medium">
              Algumas funcionalidades, como a assinatura Premium, ainda estão sendo preparadas. Não vai demorar! Aproveite o plano gratuito enquanto isso!
            </p>
          </div>
        </div>
      ) : (
        /* Código original mantido e preservado para reativação futura */
        <>
          {error && (
