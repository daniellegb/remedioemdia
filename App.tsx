...
import SubscribeOnboarding from './src/pages/SubscribeOnboarding';
...
const AppRoutes: React.FC = () => {
  ...
  return (
    <Routes>
      ...
      <Route path="/subscribe" element={<SubscribeOnboarding />} />
      <Route path="/assinar" element={<Navigate to="/subscribe" replace />} />
